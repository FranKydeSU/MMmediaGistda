...
import SearchBarBase from '../../../components/search/SearchBarBase';
import SearchBarInput from '../../../components/search/SearchBarInput';
import SearchBarToolbar from '../../../components/search/SearchBarToolbar';

import AdvancedSearch from '../../../components/maps/search/AdvancedSearch';

import { defaultSearchWrapper } from '../../../components/search/SearchBarUtils';
...
export default ({
    ...
    return (<SearchBarBase className="maps-search feature-search">
        <FormGroup>
